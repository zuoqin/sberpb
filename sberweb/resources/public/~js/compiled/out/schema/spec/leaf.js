...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__25496__auto__,k29548,else__25497__auto__){
var self__ = this;
var this__25496__auto____$1 = this;
var G__29550 = (((k29548 instanceof cljs.core.Keyword))?k29548.fqn:null);
switch (G__29550) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k29548,else__25497__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29547){
var self__ = this;
var G__29547__$1 = this;
return (new cljs.core.RecordIter((0),G__29547__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__25501__auto__,k__25502__auto__,G__29547){
var self__ = this;
var this__25501__auto____$1 = this;
var pred__29551 = cljs.core.keyword_identical_QMARK_;
var expr__29552 = k__25502__auto__;
if(cljs.core.truth_(pred__29551.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__29552))){
return (new schema.spec.leaf.LeafSpec(G__29547,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__25502__auto__,G__29547),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__25493__auto__,G__29547){
var self__ = this;
var this__25493__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__29547,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__29549){
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__29549),null,cljs.core.dissoc.call(null,G__29549,new cljs.core.Keyword(null,"pre","pre",2118456869)),null));
});
...
//# sourceMappingURL=leaf.js.map?rel=1486291262574