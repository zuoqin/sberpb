...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__25496__auto__,k29531,else__25497__auto__){
var self__ = this;
var this__25496__auto____$1 = this;
var G__29533 = (((k29531 instanceof cljs.core.Keyword))?k29531.fqn:null);
switch (G__29533) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k29531,else__25497__auto__);
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29530){
var self__ = this;
var G__29530__$1 = this;
return (new cljs.core.RecordIter((0),G__29530__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__25501__auto__,k__25502__auto__,G__29530){
var self__ = this;
var this__25501__auto____$1 = this;
var pred__29534 = cljs.core.keyword_identical_QMARK_;
var expr__29535 = k__25502__auto__;
if(cljs.core.truth_(pred__29534.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__29535))){
return (new schema.spec.variant.VariantSpec(G__29530,self__.options,self__.err_f,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__29534.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__29535))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__29530,self__.err_f,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__29534.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__29535))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__29530,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__25502__auto__,G__29530),null));
}
}
}
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__25493__auto__,G__29530){
var self__ = this;
var this__25493__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__29530,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__29532){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__29532),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__29532),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__29532),null,cljs.core.dissoc.call(null,G__29532,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941)),null));
});
...
var args29538 = [];
var len__25947__auto___29541 = arguments.length;
var i__25948__auto___29542 = (0);
while(true){
if((i__25948__auto___29542 < len__25947__auto___29541)){
args29538.push((arguments[i__25948__auto___29542]));

var G__29543 = (i__25948__auto___29542 + (1));
i__25948__auto___29542 = G__29543;
continue;
} else {
}
break;
...
//# sourceMappingURL=variant.js.map?rel=1486291262504