...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__25496__auto__,k29490,else__25497__auto__){
var self__ = this;
var this__25496__auto____$1 = this;
var G__29492 = (((k29490 instanceof cljs.core.Keyword))?k29490.fqn:null);
switch (G__29492) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k29490,else__25497__auto__);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29489){
var self__ = this;
var G__29489__$1 = this;
return (new cljs.core.RecordIter((0),G__29489__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__25501__auto__,k__25502__auto__,G__29489){
var self__ = this;
var this__25501__auto____$1 = this;
var pred__29493 = cljs.core.keyword_identical_QMARK_;
var expr__29494 = k__25502__auto__;
if(cljs.core.truth_(pred__29493.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__29494))){
return (new schema.spec.collection.CollectionSpec(G__29489,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__29493.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__29494))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__29489,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__29493.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__29494))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__29489,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__29493.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__29494))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__29489,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__25502__auto__,G__29489),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__25493__auto__,G__29489){
var self__ = this;
var this__25493__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__29489,self__.__extmap,self__.__hash));
});
...
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__29491){
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__29491),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__29491),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__29491),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__29491),null,cljs.core.dissoc.call(null,G__29491,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)),null));
});
...
var seq__29501_29505 = cljs.core.seq.call(null,coll);
var chunk__29502_29506 = null;
var count__29503_29507 = (0);
var i__29504_29508 = (0);
while(true){
if((i__29504_29508 < count__29503_29507)){
var x_29509 = cljs.core._nth.call(null,chunk__29502_29506,i__29504_29508);
item_fn.call(null,x_29509);
...
var c__25683__auto___29516 = cljs.core.chunk_first.call(null,seq__29501_29515__$1);
var G__29517 = cljs.core.chunk_rest.call(null,seq__29501_29515__$1);
var G__29518 = c__25683__auto___29516;
var G__29519 = cljs.core.count.call(null,c__25683__auto___29516);
var G__29520 = (0);
...
var x_29521 = cljs.core.first.call(null,seq__29501_29515__$1);
item_fn.call(null,x_29521);
...
//# sourceMappingURL=collection.js.map?rel=1486291262397