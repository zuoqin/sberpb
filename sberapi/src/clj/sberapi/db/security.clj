...
(defn security-to-map [security]
  (let [
    ...
    newsec {:id (nth security 0) :acode (nth security 1) :exchange (nth security 2) :isin (nth security 3) :price price :anr anr :target target :currency (nth security 4) :assettype (nth security 5)}
